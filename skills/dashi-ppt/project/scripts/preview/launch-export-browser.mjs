...
export async function launchExportBrowser(chromium, { fallbackTmpDirs = [], log = () => {} } = {}) {
  ...
  try {
    ...
    // 拉進瀏覽器主程序,進而向 WindowServer 查詢真實顯示器建立重新整理同步
