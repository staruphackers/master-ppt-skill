...
| `theme03` | 深淺程式碼風 | 技術方案、開發者大會、系統架構、AI 工程實踐 | 工程師、技術管理者、架構師、開發者社群 |
| `theme04` | 玻璃糖果風 | 年輕化品牌、消費產品、創意提案、社群媒體感內容 | 品牌團隊、設計師、內容創作者、消費品團隊 |
| `theme05` | 色譜圖表風 | 資料報告、市場分析、KPI 復盤、行業研究 | 資料分析師、諮詢顧問、研究員、業務負責人 |
...
| `theme11` | 高能增長風 | 增長復盤、商業計劃、融資路演、市場擴張方案 | 創業者、增長團隊、銷售團隊、VC/PE 路演團隊 |
...
`variantOutputMode:"comparison"` 預設按邏輯頁順序展開 4N 個物理頁;`"selected-only"` 只輸出每組標記的方案,共 N 頁。v4 繼承當前主題且無模板屬性控制項,但仍可選擇、儲存和匯出。
